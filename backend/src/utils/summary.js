function buildSummary({ candidate, scores }) {
    ...
    return `${candidate.name || 'The candidate'} demonstrated a solid understanding of ${focus} concepts with an average score of ${average}/10. ${topAnswer ? `Their strongest response covered "${topAnswer.question.prompt}".` : ''
        }`;
}
